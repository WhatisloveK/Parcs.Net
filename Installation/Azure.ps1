Function Create-VMConfig
{
	...
	New-AzureRmVMConfig -VMName $VMName -VMSize Standard_DS1 | `
...
New-AzureRmResourceGroup -Name ParcsResourceGroup -Location centralus

# Create a subnet configuration
$subnetConfig = New-AzureRmVirtualNetworkSubnetConfig -Name mySubnet -AddressPrefix 192.168.1.0/24

# Create a virtual network
$vnet = New-AzureRmVirtualNetwork -ResourceGroupName ParcsResourceGroup -Location centralus `
-Name MYvNET -AddressPrefix 192.168.0.0/16 -Subnet $subnetConfig

# Create a public IP address and specify a DNS name
$pip = New-AzureRmPublicIpAddress -ResourceGroupName ParcsResourceGroup -Location centralus `
...
$nsg = New-AzureRmNetworkSecurityGroup -ResourceGroupName ParcsResourceGroup -Location centralus `
...
$nic = New-AzureRmNetworkInterface -Name myNic -ResourceGroupName ParcsResourceGroup -Location centralus `
...
New-AzureRmVM -ResourceGroupName ParcsResourceGroup -Location centralus -VM $vmConfig
